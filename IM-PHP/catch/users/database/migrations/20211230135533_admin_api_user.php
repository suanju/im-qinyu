...
class AdminApiUser extends Migrator
{
    /**
     * Change Method.
     *
    ...
    {
        $table = $this->table('admin_api_user', ['engine' => 'InnoDB', 'collation' => 'utf8mb4_general_ci', 'comment' => '用户表' ,'id' => 'id' ,'primary_key' => ['id']]);
        $table->addColumn('username', 'string', ['limit' => 255,'null' => false,'default' => '','signed' => true,'comment' => '用户名',])
			...
			->addIndex(['username'], ['name' => 'admin_api_user_username'])
            ->create();
    }
}
